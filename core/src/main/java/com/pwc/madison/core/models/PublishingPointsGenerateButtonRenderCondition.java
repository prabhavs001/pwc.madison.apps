...
/**
 * Render condition to determine whether the "Generate I/O" button should render in publishing console of fullcycle and simple workflows
 */
@Model(adaptables = SlingHttpServletRequest.class)
public class PublishingPointsGenerateButtonRenderCondition {

    public static final Logger LOGGER = LoggerFactory.getLogger(PublishingPointsGenerateButtonRenderCondition.class);
    ...
    protected void init() {
        ...
        try {
            ...
            LOGGER.error("WorkflowException in init of PublishingPointsGenerateButtonRenderCondition {}",e);
        } finally {
