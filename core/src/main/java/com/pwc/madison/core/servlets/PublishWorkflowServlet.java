...
@Component(service = Servlet.class,
           ...
           property = { Constants.SERVICE_DESCRIPTION + "=Servlet to invoke DITA Publish Workflow",
                   "sling.servlet.methods=" + "POST", "sling.servlet.paths=" + "/bin/pwc-madison/fullcycleworkflow" })
public class PublishWorkflowServlet extends SlingAllMethodsServlet {
    private static final long serialVersionUID = 1L;

    protected final Logger log = LoggerFactory.getLogger(PublishWorkflowServlet.class);
    ...
    protected void handleOperationCreateReview(SlingHttpServletRequest request, SlingHttpServletResponse response)
        ...
        try {
            ...
            String assignTo = request.getParameter("reviewers");
            ...
            WorkflowModel wfModel = wfSession.getModel(DITAConstants.WF_MODEL_FULL_CYCLE_REVIEW_DITAMAP_KEY);
            ...
            wfData.getMetaDataMap().put(DITAConstants.ASSIGNEE,
                    assignTo + MadisonConstants.COMMA_SEPARATOR + approvers + MadisonConstants.COMMA_SEPARATOR
                            + publishers);
            wfData.getMetaDataMap().put(DITAConstants.REVIEWER, assignTo);
    ...
    protected void doPost(final SlingHttpServletRequest req, final SlingHttpServletResponse resp)
        ...
        log.debug("INSIDE doGet of PublishWorkflowServlet");
