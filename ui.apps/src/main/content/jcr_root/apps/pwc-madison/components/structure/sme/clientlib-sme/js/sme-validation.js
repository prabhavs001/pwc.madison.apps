 (function($, window, document) {
    ...
    registry.register("foundation.validation.validator", {
        ...
        selector: "[data-validation=sme-validation]",
        validate: function(el) {
             ...
             */
            if ((value !== undefined && value.length > 0) && pattern) {
                    ...
                    if (error) {
                        return "Please enter a valid " + pattern + " value";
                    }
            } // value and pattern check

        } // validate
    }); //register.register
}($, window, document)); //start of function